	...
	<section id="one">
		<div class="inner">
			...
			<div class="row">
				<div class="inner">
					<h3>Speaker Bio</h3>
					<p>As the author of <i><a href="https://tinyurl.com/rosemary-iac">Infrastructure as Code, Patterns and Practices</a></i>,
					   ...
					   as a contributor, public speaker, writer, and advocate of open source infrastructure tools.</p>
